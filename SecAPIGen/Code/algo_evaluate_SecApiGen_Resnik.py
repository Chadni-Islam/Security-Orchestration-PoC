...
# this code perform the evaluation of SecAPIgen to see the performance variation with Resnik similarity metrics
    ...
    while score < 10:
        ...
        for task in task_list:
            ...
            if data[1] == api1_list[i]:
                ...
                wp_score = wordnet_similarity.find_similarity_resnik(data[1], api1_list_unique)
        ...
        df.to_csv(('predicted/resnik_api1_generated_label'+str(score)+'.csv'))
