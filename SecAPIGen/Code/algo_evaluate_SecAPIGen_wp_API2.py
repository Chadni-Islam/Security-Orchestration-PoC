...
#this code evaluate SecAPIGen for wp similarity metrics for API2
    ...
    while score < 1:
        ...
        for task in task_list:
            ...
            if data[2] == api2_list[i]:
                ...
                wp_score = wordnet_similarity.find_similarity_wp(data[2], api2_list_unique)
        ...
        df.to_csv(('predicted/api2_generated_label'+str(score)+'.csv'))
